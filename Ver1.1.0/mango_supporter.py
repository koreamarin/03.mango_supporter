...
class MainDialog(QDialog) :
    def __init__(self) :
        ...
        self.mapping_ID_edit.returnPressed.connect(self.mapping_login)
        self.mapping_PW_edit.returnPressed.connect(self.mapping_login)
...
##################################자동 창 정렬 함수################################################
    ...
    def Alignmenter_login(self) :
        ...
        try : 
            ...
            # 더망고 솔루션 설치 페이지로 이동
            self.alignmenter_driver.execute_script('window.open("https://chrome.google.com/webstore/detail/%EB%8D%94%EB%A7%9D%EA%B3%A0-%EC%86%94%EB%A3%A8%EC%85%98/lgfjcapohoongednoojdaiedebgbcelp?hl=ko&authuser=0")')
